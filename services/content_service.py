...
DEFAULT_MESSAGES = {
    ...
    "msg_cancel_refund_client": (
        "✅ Запись отменена.\n\n"
        "Предоплата за бронь окошка (400 ₽) подлежит возврату.\n"
        "Напиши мастеру {master} — или просто подожди, мастер сама свяжется с тобой по возврату."
    ),
